    ...
    >
      <div className="absolute inset-[-4.17%_0]">
        <svg
          ...
          viewBox="0 0 20 21.6667"
        >
          <g id="Social Media logo">
            <path
              d={svgPaths.p3ca0dd00}
              fill="var(--fill-0, #2E7E96)"
              id="Vector"
            />
          </g>
        </svg>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a
                href="tel:+919723241413"
                className="flex items-center gap-2 text-sm md:text-base text-[#6d737a] hover:text-[#14627a] transition"
              >
              ...
              >
                ...
                <span>
                  IHub Gujarat, Navrangpura, 380015 Ahmedabad, Gujarat
                </span>
              </a>

              <a
                href="mailto:Info@tejeelinnovations.com"
                className="flex items-center gap-2 text-sm md:text-base text-[#363a3d] hover:text-[#14627a] transition"
              >
